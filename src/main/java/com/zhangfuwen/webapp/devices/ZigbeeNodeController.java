...
//        List<CoilOrSensor> devices = coilOrSensorRepository.findByGatewayIdAndNodeAddrAndChannelAndCreatedAfter(
//                gatewayid,nodeaddr,channel,
//                since
//        );
        //logger.validators(devices.toString());
        ...
        //model.addAttribute("devices", sensorsString);
        //return "trend";
    }
}
